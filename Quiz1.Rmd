...
```{r}
# true.posive/(true.posive + false.negative) = 0.75
# true.negative/(true.negative + false.positive) = 0.52
# (true.positive + false.negative) / (true.positive + false.negative + true.negative + false.positive) = 0.3
